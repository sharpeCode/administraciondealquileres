...
class CifrasEnLetras {
    ...
    public static $listaOrdenesMillonSingular = array ( // Letras en singular de los órdenes de millón
        ...
        "undecillon", "duodecillon", "tridecillón", "cuatridecillon", "quidecillon",
    ...
    public static $listaUnidadesOrdinales = array ( // Letras de los ordinales entre 0º y 19º
        ...
        "decimo", "undécimo", "duodecimo", "decimotercer", "decimocuarto", "decimoquinto", "decimosexto", "decimoseptimo", "decimoctavo", "decimonoveno"
    );
    ...
    public static $listaCentenasOrdinales = array ( // Letras de las centenas ordinales
        "", "centesimo", "ducentesimo", "tricentesimo", "cuadringentesimo", "quingentesimo", "sexcentesimo", "septingentesimo", "octingentesimo", "noningentesimo"
    );
    public static $listaPotenciasDiezOrdinales = array ( // Letras de las potencias de diez ordinales
        "", "decimo", "centesimo", "milesimo", "diezmilesimo", "cienmilesimo", "millonesimo"
    );
    ...
    */
    public static function convertirEurosEnLetras($euros, $numeroDecimales=0) {
        return self::convertirNumeroEnLetras($euros, $numeroDecimales,
            //"euro", "pesos", false, "nada", "nada", false);
        "pesos", "pesos", "", "", "", "");
    }
